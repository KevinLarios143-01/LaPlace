      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card-header" style="text-align:center ;">
            <h2 style="color: #62ce5c;">Precios</h2>
          </div>
          <div class="card-body">
            <form class="row g-3">
              <form class="row g-3; was-validated">
                <div class="col-md-5 offset-1">
                  ...
                  <select v-model="re" 
                        style="    
                          ...
                          border: 1px solid #ced4da; -webkit-appearance: none; -moz-appearance: none;
                          appearance: none; border-radius: 0.375rem; transition: border-color .15s ease-in-out,box-shadow .15s ease-in-out;" required>
                ...
                <div class="col-md-5">
                  ...
                  <select v-model="des" 
                          ...
                          border-radius: 0.375rem; transition: border-color .15s ease-in-out,box-shadow .15s ease-in-out;" required>
                    <option disabled value="">Seleccione un Departamento</option>
                    <option v-for="a in aDepartamentos" v-bind:key="a.code" >
                      {{ a.label + "-" + a.code }}
                    </option>
                ...
                <div class="col-md-5 offset-1">
                  ...
                  <input type="number" class="form-control" v-model="precio" placeholder="Ingrese nombre" required>
                </div>
              </form>
            </form>
            <br>
  ...
  export default {
    ...
    methods:{
      ...
      guardar() {
        ...
        if((this.cod_origen == "") || (this.cod_destino == "") || (this.precio == "")){
